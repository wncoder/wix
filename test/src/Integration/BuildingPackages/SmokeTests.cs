...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Integration.BuildingPackages
{
    ...
    public class SmokeTests
    {
        ...
        {
            string testDirectory = Environment.ExpandEnvironmentVariables(@"%WIX%\test\data\Integration\BuildingPackages\SmokeTests\Scenario02");
            ...
            // Verify
            Verifier.VerifyResults(@"%WIX%\test\data\Integration\BuildingPackages\SmokeTests\Scenario02\expected.msi", light.OutputFile);
        }
    }
}
