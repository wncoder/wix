//-----------------------------------------------------------------------
// <copyright file="Bundle.LayoutTests.cs" company="Microsoft">
...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Integration.BuildingPackages.Bundle
{
    ...
    public class LayoutTests : BundleTests
    {
        ...
        [Priority(3)]
        [Ignore]
        // bug https://sourceforge.net/tracker/?func=detail&aid=2980722&group_id=105970&atid=642714
        public void LayoutDirectoryInvalidName()
        {
            string candleOutput = Candle.Compile(Path.Combine(LayoutTests.TestDataDirectory, @"LayoutDirectoryInvalidName\Product.wxs"));
        ...
        [Priority(3)]
        [Ignore]
        // bug https://sourceforge.net/tracker/index.php?func=detail&aid=2980803&group_id=105970&atid=642714
        ...
        [Priority(3)]
        [Ignore]
        // bug: https://sourceforge.net/tracker/?func=detail&aid=2981229&group_id=105970&atid=642714
        ...
        [Priority(2)]
        // bug https://sourceforge.net/tracker/?func=detail&aid=2981263&group_id=105970&atid=642714
        ...
        [Priority(2)]
        // bug https://sourceforge.net/tracker/?func=detail&aid=2980757&group_id=105970&atid=642714
