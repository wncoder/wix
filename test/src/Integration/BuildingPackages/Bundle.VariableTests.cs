//-----------------------------------------------------------------------
// <copyright file="Bundle.VariableTests.cs" company="Microsoft">
...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Integration.BuildingPackages.Bundle
{
    ...
    public class VariableTests : BundleTests
    {
        ...
        /// <summary>
        /// Verifies Variable information in ParameterInfo.xml and Burn_Manifest.xml.
        /// </summary>
        ...
        public static void VerifyVariableInformation(string embededResourcesDirectoryPath, string variableName, string variableValue, VariableType variableType)
        {
            ...
            string parameterInfoXPath = string.Format(@"//pi:Variable[@Id='{0}']", variableName);
            XmlNodeList parameterInfoNodes = BundleTests.QueryParameterInfo(embededResourcesDirectoryPath, parameterInfoXPath);
            Assert.AreEqual(1, parameterInfoNodes.Count, "No Variable with the name: '{0}' was found in ParameterInfo.xml.", variableName);
            BundleTests.VerifyAttributeValue(parameterInfoNodes[0], "Value", variableValue);
            BundleTests.VerifyAttributeValue(parameterInfoNodes[0], "Type", expectedVariableTypeName);
