//-----------------------------------------------------------------------
// <copyright file="Bundle.DirectorySearchTests.cs" company="Microsoft">
...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Integration.BuildingPackages.Bundle
{
    ...
    public class DirectorySearchTests : BundleTests
    {
        ...
        public void DirectorySearchInvalidPath()
        {
            ...
            light.ExpectedWixMessages.Add(new WixMessage(91, "Duplicate symbol 'DirectorySearch:DirectorySearch1' found.", Message.MessageTypeEnum.Error));
        ...
        // bug 879792
        [TestMethod]
        [Description("DirectorySearch @Variable refrences an undefined variable.")]
        [Priority(3)]
        [Ignore]
        public void DirectorySearchUndefinedVariable()
        {
            string sourceFile = Path.Combine(DirectorySearchTests.TestDataDirectory, @"DirectorySearchUndefinedVariable\Product.wxs");
            string[] candleOutputs = Candle.Compile(sourceFiles: new string[] { sourceFile }, extensions: new string[] { "WixUtilExtension" });
        ...
        /// <summary>
        /// Verifies DirectorySearch information in ParameterInfo.xml and Burn_Manifest.xml.
        /// </summary>
        ...
        public static void VerifyDirectorySearchInformation(string embededResourcesDirectoryPath, string expectedId, string expectedPath, string expectedVariableName, string expectedCondition, string expectedResult)
        {
            ...
            string parameterInfoXPath = string.Format(@"//pi:DirectorySearch[@Id='{0}']", expectedId);
            XmlNodeList parameterInfoNodes = BundleTests.QueryParameterInfo(embededResourcesDirectoryPath, parameterInfoXPath);
            Assert.AreEqual(1, parameterInfoNodes.Count, "No DirectorySearch with the Id: '{0}' was found in ParameterInfo.xml.", expectedId);
        ...
        {
            BundleTests.VerifyParameterInfoElementOrder(embededResourcesDirectoryPath, "DirectorySearch", "Id", directorySearchIds);
