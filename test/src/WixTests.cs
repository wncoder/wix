...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests
{
    ...
    public class WixTests
    {
        ...
        /// </summary>
        public bool CleanTestArtifacts = false;

        /// <summary>
        /// A list of files and directories that are considered to be test artifacts
        /// </summary>
        protected List<FileSystemInfo> TestArtifacts = new List<FileSystemInfo>();
        ...
        public bool IsRuntimeTestsEnabled
        {
            get
            {
                ...
                if (!String.IsNullOrEmpty(runtimeTestsEnabled) && runtimeTestsEnabled.ToLower().Equals("true"))
                {
                    return true;
                }
                else
        ...
        public void WixTestTestInitialize()
        {
            ...
            System.Reflection.MethodInfo testMethodInformation = this.GetType().GetMethod(TestContext.TestName);
            ...
            {
                if (property.Name.Equals("IsRuntimeTest") && property.Value.Equals("true") && !IsRuntimeTestsEnabled)
                {
                ...
                if (property.Name.Equals("Is64BitSpecificTest") && property.Value.Equals("true") && !Is64BitMachine)
                {
            ...
            this.testDirectory = Builder.GetUniqueFileName(this.TestContext.TestDir);
            Builder.CreateOutputDirectory(this.TestDirectory);
            ...
            Builder.SetWorkingDirectory(this.TestDirectory);
        }
        ...
        {
            // Make sure all installed products are removed
            ...
            if (this.TestContext.CurrentTestOutcome == UnitTestOutcome.Passed)
            {
                if (this.CleanTestArtifacts)
                {
                    ...
                    {
                        if (artifact.GetType().Equals(typeof(DirectoryInfo)))
                        {
