...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Extensions.UtilExtension
{
    ...
    public class FileShareTests : WixTests
    {
        ...
        public void FileShare_ExistingShare()
        {
            ...
            // create the share
            string testFolderPath = Path.Combine(@"\\" + System.Environment.MachineName, "TestShareName");
            string testForderPhysicalPath = Builder.GetUniqueFileName();
            Directory.CreateDirectory(testForderPhysicalPath);
            CreateShare(testForderPhysicalPath, "TestShareName");
        ...
        private static bool CreateShare(string sharePath, string shareName)
        {
