...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Tools.Common.Logo
{
    ...
    {
        private static readonly string LogoOutputRegexString = @"Microsoft \(R\) Windows Installer Xml {0} version 3\.5\.\d\d\d\d.0" + Environment.NewLine + @"Copyright \(C\) Microsoft Corporation\. All rights reserved\.";
