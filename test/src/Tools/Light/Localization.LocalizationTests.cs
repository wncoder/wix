...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Tools.Light.Localization
{
    ...
    public class LocalizationTests : WixTests
    {
        ...
        public void Hebrew()
        {
            ...
            light.LocFile = Path.Combine(LocalizationTests.TestDataDirectory, @"he-il\he-il.wxl");
        ...
        public void ValidIdentifier()
        {
            ...
            light.LocFile = Path.Combine(LocalizationTests.TestDataDirectory, @"ValidIdentifier\en-us.wxl");
