//-----------------------------------------------------------------------
// <copyright file="Input.WixlibTests.cs" company="Microsoft">
...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Tools.Light.Input
{
    ...
    {
        private static readonly string TestDataDirectory = Environment.ExpandEnvironmentVariables(@"%WIX%\test\data\Tools\Light\Input\WixlibTests");
        ...
        public void SingleWixlib()
        {
            ...
            candle.OutputFile = "BasicProduct.wixobj";
            candle.Run();

            //Building the expected msi directly from wixobj
            Light light1 = new Light();
            light1.ObjectFiles.Add(candle.OutputFile);
            light1.OutputFile = Path.Combine(candle.OutputDirectory, "expected.msi");
            light1.Run();
            ...
            light2.OutputFile = Path.Combine(candle.OutputDirectory, "actual.msi");
            light2.Run();
        ...
        public void MultipleWixlibs()
        {
            ...
            Builder.CreateOutputDirectory(outputDirectory);
