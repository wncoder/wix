...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Tools.Candle.Input
{
    ...
    {
        private static readonly string TestDataDirectory = Environment.ExpandEnvironmentVariables(@"%WIX%\test\data\Tools\Candle\Input\FileSystemTests");
        ...
        public void LongFilePath()
        {
            ...
            string InputPath = Builder.GetUniqueFileName();
