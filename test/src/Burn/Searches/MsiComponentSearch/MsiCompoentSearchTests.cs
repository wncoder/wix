...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Burn.Searches
{
    ...
    public class MsiCompoentSearchTests : WixTests
    {
        ...
        public void BurnMsiComponentSearchDataDriven()
        {
            ...
            ComponentSearchElement.ComponentSearchResultType resultType =
                (ComponentSearchElement.ComponentSearchResultType)Enum.Parse(typeof
               (ComponentSearchElement.ComponentSearchResultType), (string)TestContext.DataRow[5], true);

            fixture.CreateMsiComponentSearchElement(id, resultType, variable, productCode, componentId, condition);

            string expectedValue = TestContext.DataRow[6].ToString();

            bool result = fixture.SearchResultVerification(expectedValue, resultType, variable);
