...
namespace Microsoft.Tools.WindowsInstallerXml.Test.Tests.Burn.RebootResume
{
    ...
    public class BurnRebootResumeScenariosTests : BurnTests
    {
        ...
        [TestMethod]
        [Description("verify a bundle can be rebooted in the middle of an install")]
        ...
        public void BurnRebootResumeBundleDataDriven()
        {
            ...
            {
                BurnRebootResumeScenariosFixture.RebootType rebootType = (BurnRebootResumeScenariosFixture.RebootType)Enum.Parse(typeof(BurnRebootResumeScenariosFixture.RebootType), (string)TestContext.DataRow[1], true);
