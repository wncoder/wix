...
namespace Microsoft.Tools.WindowsInstallerXml.Test
{
    ...
    public static class Verifier
    {
        ...
        /// </summary>
        /// <param name="parameterInfoPath">Path to the ParameterInfo file</param>
        /// <param name="xpathQuery">XPath Query</param>
        /// <returns>List of XmlNodes that match the query</returns>
        /// <remarks>The namespace that should be used is 'pi'</remarks>
        public static XmlNodeList QueryParameterInfo(string parameterInfoPath, string xpathQuery)
        {
            XmlNamespaceManager xmlNamespaceManager = new XmlNamespaceManager(new NameTable());
            xmlNamespaceManager.AddNamespace("pi", "http://schemas.microsoft.com/Setup/2008/01/im");
            XmlNodeList nodeList = Verifier.QueryXML(parameterInfoPath, xpathQuery, xmlNamespaceManager);
            return nodeList;
        }
