//-----------------------------------------------------------------------
// <copyright file="LightArguments.cs" company="Microsoft">
    ...
    public partial class Light
    {
        ...
        public override string Arguments
        {
            get
            {
                ...
                {
                    arguments.AppendFormat(@" -b ""{0}""", this.BasePath);
                }
                ...
                // LocFile
                if (!String.IsNullOrEmpty(this.LocFile))
                {
                    arguments.AppendFormat(@" -loc ""{0}""", this.LocFile);
                }
