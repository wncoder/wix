//-----------------------------------------------------------------------
// <copyright file="MSBuildMessage.cs" company="Microsoft">
...
namespace Microsoft.Tools.WindowsInstallerXml.Test
{
    ...
    public class MSBuildMessage : Message
    {
        ...
        /// </summary>
        private static Regex MSBuildMessageRegex = new Regex(@"^.*: (?<messageType>error|warning) [^:\d]*(?<messageNumber>\d*).*: (?<messageText>[^\n\r]*).*$", RegexOptions.ExplicitCapture | RegexOptions.Singleline);
    }
}
