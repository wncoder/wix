...
Before a contributor's first pull request is put into the repository they must sign an [assignment agreement](/about/assignment-agreement/). The pull request can be submitted and discussed but it cannot be committed to the repository without the appropriate paperwork in place.

**How to become a Contributor:** Discuss your idea for contribution on the [wix-devs mailing list](/documentation/mailinglist). If it aligns with the project's goals, sign an [assignment agreement](/about/assignment-agreement/) and submit a [pull request](https://wix.codeplex.com/sourcecontrol/network). If the code meets all the requirements we'll accept it and merge it into the project.
