//---------------------------------------------------------------------
// <copyright file="MakeSfxCA.cs" company="Microsoft">
...
namespace Microsoft.Deployment.Tools.MakeSfxCA
{
    ...
    public class MakeSfxCA
    {
        ...
        public static void Usage(TextWriter w)
        {
            ...
            w.WriteLine("Copyright (C) Microsoft Corporation. All rights reserved.");
            w.WriteLine();
        ...
        public static void Build(string output, string sfxdll, IList<string> inputs, TextWriter log)
        {
            ...
            {
                if (String.Compare(Path.GetFileName(input), MakeSfxCA.RequiredWIAssembly,
            ...
            MakeSfxCA.ResolveDependentAssemblies(inputs, Path.GetDirectoryName(customActionAssembly));
            ...
            MakeSfxCA.PackInputFiles(output, inputs);
        ...
        /// </remarks>
        private static void ResolveDependentAssemblies(IList<string> inputFiles, string inputDir)
        {
        ...
        /// output SfxCA.dll.
        /// </summary>
        private static void PackInputFiles(string outputFile, IList<string> inputs)
        {
            log.WriteLine("Packaging files");

            IDictionary<string, string> fileMap = GetPackFileMap(inputs);
