...
namespace Microsoft.VisualStudio.Package
{
        ...
        IVsDeferredSaveProject
    {
        ...
        protected virtual void AddNewFileNodeToHierarchy(HierarchyNode parentNode, string fileName, string linkPath, VSADDFILEFLAGS addFlags)
        {
            HierarchyNode child;
            ...
            for (int index = 0; index < filesToAdd.Count; index++)
            {
                ...
                if (child != null)
                {
                    ...
                    if (NativeMethods.IsSamePath(file, newFileName))
                    {
                        ...
                        if (!(childFileNode != null && childFileNode.IsLink))
                        {
                            ...
                            if (isNonMemberItem != null && ((bool)isNonMemberItem))
                            {
                ...
                else
                {
                    ...
                    if (existingLink != null)
                    {
                        ...
                        this.AddNewFileNodeToHierarchy(n, newFileName, null, addFlags);
                    }
                    else if (overwrite)
                    {
