...
namespace Microsoft.Tools.WindowsInstallerXml.VisualStudio
{
    ...
    public class WixFileNode : FileNode, IProjectSourceNode
    {
        ...
        /// <summary>
        /// Holds node properties object.
        /// </summary>
        private NodeProperties currentNodeProperties; // Named as currentNodeProperties instead of nodeProperties becuase it is already there in the base class.
        ...
        public override NodeProperties NodeProperties
        {
            ...
            get
            {
                if (this.currentNodeProperties == null)
                {
                    this.currentNodeProperties = this.CreatePropertiesObject();
                }

                return this.currentNodeProperties;
            }
        }
        ...
        protected void ResetProperties()
        {
            ...
            if (this.IsNonMemberItem)
            {
                if (!(this.currentNodeProperties is WixFileNodeNonMemberProperties))
                {
                    this.currentNodeProperties = new WixFileNodeNonMemberProperties(this);
                    changed = true;
                }
            }
            else
            {
                if (!(this.currentNodeProperties is WixFileNodeProperties))
                {
                    this.currentNodeProperties = new WixFileNodeProperties(this);
                    changed = true;
                }
            }
