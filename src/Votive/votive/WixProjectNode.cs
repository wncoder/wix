...
namespace Microsoft.Tools.WindowsInstallerXml.VisualStudio
{
    ...
    public class WixProjectNode : ProjectNode
    {
        ...
        {
            if (WixProjectNode.nodeIcon == null)
            {
                WixProjectNode.nodeIcon = new Icon(WixStrings.ProjectFileIcon, new Size(16, 16));
            }

            return WixProjectNode.nodeIcon.Handle;
        }
