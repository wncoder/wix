...
namespace Microsoft.Tools.WindowsInstallerXml.VisualStudio.PropertyPages
{
    ...
    internal abstract class WixPropertyPage : IPropertyPage
    {
        // =========================================================================================
        // Member Variables
        // =========================================================================================
        ...
        /// the last call to <see cref="IPropertyPage.Apply" />.
        /// </summary>
        [Browsable(false)]
        ...
        private void ResizeContents(RECT newBounds)
        {
            if (this.PropertyPagePanel != null && this.PropertyPagePanel.IsHandleCreated)
            {
                ...
                this.PropertyPagePanel.Bounds = new Rectangle(
                    newBounds.left,
                    newBounds.top,
                    Math.Max(newBounds.right - newBounds.left, this.PropertyPagePanel.Bounds.Width),
                    Math.Max(newBounds.bottom - newBounds.top, this.PropertyPagePanel.Bounds.Height));
            }
        }
    }
}