...
namespace Microsoft.Tools.WindowsInstallerXml
{
    ...
    public sealed class TableDefinition : IComparable<TableDefinition>
    {
        ...
        /// <param name="createSymbols">Flag if rows in this table create symbols.</param>
        /// <param name="unreal">Flag if table is unreal.</param>
        /// <param name="uxManifest">Flag if table is part of UX Manifest.</param>
        public TableDefinition(string name, bool createSymbols, bool unreal, bool uxManifest)
        {
            this.name = name;
            this.createSymbols = createSymbols;
            this.unreal = unreal;
            this.uxManifest = uxManifest;
        ...
        /// <summary>
        /// Gets if the table is a part of the UX manifest.
        /// </summary>
        /// <value>Flag if table is a part of the UX manifest.</value>
        public bool IsUxManifest
        {
            get { return this.uxManifest; }
        }
        ...
        internal static TableDefinition Parse(XmlReader reader)
        {
            ...
            while (reader.MoveToNextAttribute())
            {
                switch (reader.LocalName)
                {
                    ...
                    case "unreal":
                        ...
                        break;
                    case "uxManifest":
                        uxManifest = Common.IsYes(SourceLineNumberCollection.FromUri(reader.BaseURI), "tableDefinition", reader.Name, reader.Value);
                        break;
                    default:
            ...
            TableDefinition tableDefinition = new TableDefinition(name, createSymbols, unreal, uxManifest);
        ...
        internal void Persist(XmlWriter writer)
        {
            ...
            if (this.uxManifest)
            {
                writer.WriteAttributeString("uxManifest", "yes");
            }
