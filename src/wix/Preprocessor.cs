...
namespace Microsoft.Tools.WindowsInstallerXml
{
    ...
    public sealed class Preprocessor
    {
        ...
        {
            StringWriter processed = new StringWriter(CultureInfo.InvariantCulture);
            ...
            using (StringReader sr = new StringReader(processed.ToString()))
            {
                ...
                try
                {
                    ...
                    reader = new XmlTextReader(new Uri(Path.GetFullPath(sourceFile)).AbsoluteUri, sr);
