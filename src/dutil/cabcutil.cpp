    ...
    )
{
    ...
    hr = DictCreate(&pcd->shDictHandle, dwMaxFiles, offsetof(CABC_FILE, pwzSourcePath));
    ...
    )
{
    ...
    *ppcf = NULL; // By default, we'll set our output to NULL
    ...
    hr = DictGet(pcd->shDictHandle, wzFileName, reinterpret_cast<void **>(ppcf));
    ...
    )
{
    ...
    hr = DictAdd(pcd->shDictHandle, wzFile, pcf);
