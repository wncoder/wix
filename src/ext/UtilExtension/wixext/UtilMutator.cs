...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    public sealed class UtilMutator : MutatorExtension
    {
        ...
        {
            ArrayList currentChildren = new ArrayList();
            ...
            foreach (Wix.ISchemaElement element in currentChildren)
            {
                wix.AddChild(element);
            }
            ...
            if (1600 < componentCount)
            {
                this.Core.OnMessage(UtilWarnings.FeatureComponentLimitation(this.componentGroupName, componentCount.ToString()));
            }
        }
