//-------------------------------------------------------------------------------------------------
// <copyright file="BuxExtension.cs" company="Microsoft">
//    Copyright (c) Microsoft Corporation.  All rights reserved.
// </copyright>
// 
// <summary>
// The Windows Installer XML Toolset Bux extension.
// </summary>
//-------------------------------------------------------------------------------------------------
...
namespace Microsoft.Tools.WindowsInstallerXml.Extensions
{
    ...
    /// The Windows Installer XML Toolset Bux Extension.
    /// </summary>
    public sealed class BuxExtension : WixExtension
    {
        private BuxCompiler compilerExtension;
        ...
        public override CompilerExtension CompilerExtension
        {
            get
            {
                ...
                {
                    this.compilerExtension = new BuxCompiler();
                }
        ...
        public override Library GetLibrary(TableDefinitionCollection tableDefinitions)
        {
            ...
            {
                this.library = LoadLibraryHelper(Assembly.GetExecutingAssembly(), "Microsoft.Tools.WindowsInstallerXml.Extensions.Data.bux.wixlib", tableDefinitions);
            }
