    ...
    )
{
    ...
    {
        hr = WcaWrapQuery(vcsWebSvcExtQuery, &pwzCustomActionData, efmcColumn2 | efmcColumn3, 1, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsMimeMapQuery, &pwzCustomActionData, 0, 0xFFFFFFFF, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsHttpHeaderQuery, &pwzCustomActionData, efmcColumn4, 0xFFFFFFFF, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsWebDirPropertiesQuery, &pwzCustomActionData, 0, 0xFFFFFFFF, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsWebLogQuery, &pwzCustomActionData, 0, 0xFFFFFFFF, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsWebAppExtensionQuery, &pwzCustomActionData, efmcColumn3, 0xFFFFFFFF, 0xFFFFFFFF);
    ...
    {
        hr = WcaWrapQuery(vcsPropertyQuery, &pwzCustomActionData, 0, 2, 0xFFFFFFFF);
