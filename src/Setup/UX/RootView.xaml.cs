...
namespace Microsoft.Tools.WindowsInstallerXml.UX
{
    ...
    public partial class RootView : Window
    {
        ...
        /// <summary>
        /// Allows the user to drag the window around by grabbing the title control.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void TitleControl_MouseLeftButtonDown(object sender, MouseButtonEventArgs e)
        {
            this.DragMove();
        }
    }
