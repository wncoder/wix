//--------------------------------------------------------------------------------------------------
// <copyright file="WixTask.cs" company="Microsoft Corporation">
    ...
    public abstract class WixTask : ExternalProgramBase
    {
        ...
        protected WixTask(string exeName) : base()
        {
            ...
            using (RegistryKey regKey = Registry.LocalMachine.OpenSubKey(@"SOFTWARE\Microsoft\Windows Installer XML\3.0"))
            {
                if (null != regKey)
                {
                    ...
                    {
                        this.exeDirectory = new DirectoryInfo(installRoot);
                    }
                }
            }
        }
        ...
        protected virtual void WriteOptions(TextWriter writer)
        {
            ...
            if (null != this.extensions)
            {
                ...
                {
                    writer.WriteLine("-ext \"{0}\"", extension);
                }
            }
