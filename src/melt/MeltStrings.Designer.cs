...
namespace Microsoft.Tools.WindowsInstallerXml.Tools {
    ...
    internal class MeltStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to  usage: melt.exe [-?] [-nologo] database.msi source.wxs
        ///
        ...
        ///   -x &lt;path&gt;  export binaries from msm to this path (defaults to output files path
