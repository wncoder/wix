...
function Main()
{
    ...
    try
    {
        myXmlDoc = new ActiveXObject("Msxml2.DOMDocument.4.0");
    }
    catch (e)
    {
        myXmlDoc = new ActiveXObject("Msxml2.DOMDocument.5.0");
    }
    ...
    try
    {
        mySchemaCache = new ActiveXObject ("Msxml2.XMLSchemaCache.4.0");
    }
    catch (e)
    {
        mySchemaCache = new ActiveXObject ("Msxml2.XMLSchemaCache.5.0");
    }

    try
    {
        mySchemaCache.add ("http://schemas.microsoft.com/Setup/2008/01/im", xsdFile);
