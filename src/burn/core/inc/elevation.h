...
typedef enum _BURN_ELEVATION_MESSAGE_TYPE
{
    ...
    //BURN_ELEVATION_MESSAGE_TYPE_SET_PLAN,
    //BURN_ELEVATION_MESSAGE_TYPE_REGISTER,
    //BURN_ELEVATION_MESSAGE_TYPE_UNREGISTER,
    //BURN_ELEVATION_MESSAGE_TYPE_CACHE,
    BURN_ELEVATION_MESSAGE_TYPE_EXECUTE,
    BURN_ELEVATION_MESSAGE_TYPE_ISCACHED,
    BURN_ELEVATION_MESSAGE_TYPE_VERIFYANDCACHE,
    BURN_ELEVATION_MESSAGE_TYPE_DELETETEMPCACHEDDIRECTORY,
    BURN_ELEVATION_MESSAGE_TYPE_DELETECACHEDPACKAGE,
    BURN_ELEVATION_MESSAGE_TYPE_UPDATEPACKAGELOCATION,
    //BURN_ELEVATION_MESSAGE_TYPE_ROLLBACK,

    //BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_PACKAGE_BEGIN,
    //BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_PACKAGE_ERROR,
    //BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_PACKAGE_PROGRESS,
    //BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_PACKAGE_MSI_MESSAGE,
    //BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_PACKAGE_COMPLETE,
    //BURN_ELEVATION_MESSAGE_TYPE_RESTART_REQUIRED,

    BURN_ELEVATION_MESSAGE_TYPE_PROGRESSSOFAR,
    BURN_ELEVATION_MESSAGE_TYPE_ONERROR,
    BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_MSI_MESSAGE,
    BURN_ELEVATION_MESSAGE_TYPE_EXECUTE_MSI_FILES_IN_USE,
    BURN_ELEVATION_MESSAGE_TYPE_PROGRESSONSTATECHANGE,
    BURN_ELEVATION_MESSAGE_TYPE_LOG,
    BURN_ELEVATION_MESSAGE_TYPE_CACHE_UNELEVATED_LOG_FILE,
    BURN_ELEVATION_MESSAGE_TYPE_COMPLETE,
    BURN_ELEVATION_MESSAGE_TYPE_TERMINATE,
    //BURN_ELEVATION_MESSAGE_TYPE_CHILD_UNINITIALIZE,
...
HRESULT ElevationExecutePackage(
    __in HANDLE hPipe,
    __in BURN_VARIABLES* pVariables,
    __in UINT packageIndex,
    __in UINT operation,
    __in UINT action
    );
