...
namespace Microsoft.Tools.DocCompiler
{
    ...
    public sealed class XmlSchemaCompiler
    {
        ...
        private void CollectAttributes(XmlSchemaObjectCollection attributes, XmlTextWriter writer, SortedList sortedAttributes, ref XmlSchemaAnyAttribute anyAttribute)
        {
