//-------------------------------------------------------------------------------------------------
// <copyright file="VotivePP.cs" company="Outercurve Foundation">
...
namespace Microsoft.Tools.WindowsInstallerXml.VisualStudio.Tools
{
    ...
    public sealed class VotivePP
    {
        ...
        private void PrintLogo()
        {
            ...
            Console.WriteLine("Votive Build Preprocessor version {0}", thisAssembly.GetName().Version.ToString());
            Console.WriteLine("Copyright (C) Outercurve Foundation 2003. All rights reserved.");
            Console.WriteLine();
        }
